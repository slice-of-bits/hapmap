<script lang="ts">
	...
	import { type RecipeListOutSchema, recipesApiPublicSearchRecipes } from '$lib/api/public-client';
...
<div class="relative w-full min-w-0">
	<input
		class="block w-full max-w-full min-w-0 bg-slate-300 rounded placeholder:font-medium placeholder:text-slate-500"
		bind:value={query}
